...
def run_scaled_dot_product_attention(
    ...
    """
    return attention_utils.scaled_dot_product_attention(Q, K, V, mask=mask)
...
def run_get_batch(
    ...
    """
    from cs336_basics.train import data_loading
...
def run_gradient_clipping(parameters: Iterable[torch.nn.Parameter], max_l2_norm: float) -> None:
    ...
    """
    from cs336_basics.AdamW import gradient_clipping
...
def run_get_lr_cosine_schedule(
    ...
    """
    from cs336_basics.AdamW import learning_rate_schedule
